package com.intelli.ui.pages.nav.about
...
import com.intelli.databinding.NavAboutFragmentBinding
...
class NavAboutFragment: FragmentBase(false) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        vBinding.buttonPrivacy.setOnClickListener {
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://nirajprakash.github.io/documents/intelli/privacy.html"))
            startActivity(intent)
        }
    }
}